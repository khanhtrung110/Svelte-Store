...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[0]) + " svelte-efsaf4"));
    			attr_dev(button, "type", "button");
    			add_location(button, file$4, 58, 2, 1166);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*mode*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[0]) + " svelte-efsaf4"))) {
    ...
    /* src\Cart\CartItem.svelte generated by Svelte v3.49.0 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = `${/*description*/ ctx[3]}`;
    			add_location(p, file$3, 64, 4, 1539);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 57, 2, 1274);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 58, 2, 1294);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 56, 0, 1266);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function displayDescription() {
    		...
    		const unsubscribe = products.subscribe(prods => {
    			let indexProps = prods.findIndex(p => {
    				console.log(p.id);
    				return p.id === id;
    			});

    			// description = prods[indexProps].description;
    ...
    /* src\Cart\Cart.svelte generated by Svelte v3.49.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 51, 6, 969);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (49:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 46, 2, 814);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 47, 2, 831);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 45, 0, 801);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\Products\Product.svelte generated by Svelte v3.49.0 */
    const file$1 = "src\\Products\\Product.svelte";

    // (60:6) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(60:6) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-lp9djq");
    			add_location(h1, file$1, 54, 6, 1023);
    			attr_dev(h2, "class", "svelte-lp9djq");
    			add_location(h2, file$1, 55, 6, 1047);
    			attr_dev(p, "class", "svelte-lp9djq");
    			add_location(p, file$1, 56, 6, 1071);
    			add_location(div0, file$1, 53, 4, 1010);
    			add_location(div1, file$1, 58, 4, 1109);
    			attr_dev(div2, "class", "product svelte-lp9djq");
    			add_location(div2, file$1, 52, 2, 983);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\Products\Products.svelte generated by Svelte v3.49.0 */
    ...
    // (31:4) {#each $products as product (product.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:4) {#each $products as product (product.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 29, 4, 598);
    			attr_dev(section, "class", "svelte-1k2pkx0");
    			add_location(section, file, 28, 2, 583);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
